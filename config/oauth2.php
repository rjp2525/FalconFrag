...
return [
    ...
    'grant_types' => [
        // Default grant type (password) for OAuth2 requests
        'password' => [
            'class' => \League\OAuth2\Server\Grant\PasswordGrant::class,
            'callback' => '\Falcon\Http\Controllers\Api\V1\OAuthController@authenticate',
            'access_token_ttl' => 3600,
        ],

        // Use a refresh token grant for extending sessions
        'refresh_token' => [
            'class' => \League\OAuth2\Server\Grant\RefreshTokenGrant::class,
            'access_token_ttl' => 3600,
            'refresh_token_ttl' => 5200,
        ],
    ],
