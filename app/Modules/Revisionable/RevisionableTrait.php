...
namespace Falcon\Modules\Revisionable;
...
trait RevisionableTrait
{
    ...
    {
        return $this->morphMany('\Falcon\Modules\Revisionable\Revision', 'revisionable');
    }
    ...
    {
        return \Falcon\Modules\Revisionable\Revision::where('revisionable_type', get_called_class())
        ...
        if (((!isset($this->revisionEnabled) || $this->revisionEnabled) && $this->updating) && (!$LimitReached || $RevisionCleanup)) {
            ...
            foreach ($changes_to_record as $key => $change) {
                $revisions[] = array(
                    ...
                    'revisionable_id' => $this->generateUUID(),
                    'key' => $key,
